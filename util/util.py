...
def poly_learning_rate(optimizer, base_lr, curr_iter, max_iter, power=0.9, index_split=-1, scale_lr=10., warmup=False, warmup_step=500):
    ...
    if curr_iter % 50 == 0:   
        print('Base LR: {:.6f}, Curr LR: {:.6f}, Warmup: {}.'.format(base_lr, lr, (warmup and curr_iter < warmup_step)))
...
def intersectionAndUnionGPU(output, target, K, ignore_index=255):
    ...
    area_intersection = torch.histc(intersection, bins=K, min=0, max=K-1)  # [number of '0', number of '1'] for 2 classes
